...
use rustjava_runtime::classes::java::lang::{Byte, String};
...
async fn test_byte_api() -> Result<()> {
    ...
    let text: jvm::ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
        .invoke_virtual(&value, &value.class_definition().name(), "toString", "()Ljava/lang/String;", ())
        .await?;
    ...
    let name: jvm::ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
    ...
    let decoded = jvm
        ...
        .await?;
    assert_eq!(
        jvm.invoke_virtual::<_, i8>(&decoded, &decoded.class_definition().name(), "byteValue", "()B", ())
            .await?,
        127
    );
    ...
    let result: Result<i32> = jvm
        .invoke_virtual(&value, &value.class_definition().name(), "compareTo", "(Ljava/lang/Byte;)I", (None,))
        .await;
    let Err(JavaError::JavaException(exception)) = result else {
    ...
    for (text, expected) in [("#7f", 127i8), ("0177", 127i8)] {
        ...
        let decoded: ClassInstanceRef<Byte> = jvm
            ...
            .await?;
        assert_eq!(
            jvm.invoke_virtual::<_, i8>(&decoded, "java/lang/Byte", "byteValue", "()B", ()).await?,
            expected
        );
    }
