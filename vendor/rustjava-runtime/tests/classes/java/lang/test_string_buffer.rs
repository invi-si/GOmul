...
async fn test_sb_01_constructors_capacity_and_exceptions() -> Result<()> {
    ...
    let null = ClassInstanceRef::<rustjava_runtime::classes::java::lang::String>::new(None);
...
async fn test_sb_05_append_float_double_and_char_array() -> Result<()> {
    ...
    let _: ClassInstanceRef<StringBuffer> = jvm
        ...
        .await?;
    let null_object: ClassInstanceRef<rustjava_runtime::classes::java::lang::Object> = None.into();
    let _: ClassInstanceRef<StringBuffer> = jvm
        .invoke_virtual(
            &buffer,
            "java/lang/StringBuffer",
...
async fn test_sb_10_replace_clamps_end_and_checks_ranges() -> Result<()> {
    ...
    let null: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = None.into();
    let result: Result<ClassInstanceRef<StringBuffer>> = jvm
        .invoke_virtual(
            &buffer,
            "java/lang/StringBuffer",
...
async fn test_sb_11_string_arguments_backed_by_shared_substring() -> Result<()> {
    ...
    let hello: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
        .invoke_virtual(
            &hello_parent,
    ...
    let world: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
        .invoke_virtual(
            &world_parent,
...
async fn test_sb_13_insert_substring_then_reverse_and_delete() -> Result<()> {
    ...
    let sub: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
...
async fn test_sb_14_append_surrogate_substring_preserves_code_unit() -> Result<()> {
    ...
    let _: ClassInstanceRef<StringBuffer> = jvm
        ...
        .await?;
    let text: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
        .invoke_virtual(&buffer, "java/lang/StringBuffer", "toString", "()Ljava/lang/String;", ())
        .await?;
