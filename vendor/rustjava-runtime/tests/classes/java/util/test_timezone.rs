...
async fn test_timezone() -> Result<()> {
    ...
    let id: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
    ...
    let ids: ClassInstanceRef<Array<rustjava_runtime::classes::java::lang::String>> = jvm
        .invoke_static("java/util/TimeZone", "getAvailableIDs", "()[Ljava/lang/String;", ())
        .await?;
    let ids = jvm
        .load_array::<ClassInstanceRef<rustjava_runtime::classes::java::lang::String>>(&ids, 0, jvm.array_length(&ids).await?)
        .await?;
...
async fn tz_02_to_04_id_abstract_contract_and_simple_timezone_mutation() -> Result<()> {
    ...
    let null_date: ClassInstanceRef<rustjava_runtime::classes::java::util::Date> = None.into();
