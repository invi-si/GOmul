...
pub enum WIPICSvcId {
    ...
    UpdateRecord = 0x198,
    SelectRecord = 0x199,
    AvailableDatabaseStorage = 0x19c,
    Unk8 = 0x1a0,
    Connect = 0x258,
    Close = 0x259,
    SocketWrite = 0x25c,
    SocketClose = 0x25e,
    HostToNetworkShort = 0x385,
    ClipCreate = 0x4b0,
    ClipFree = 0x4b1,
    ClipPutData = 0x4b3,
    Unk15 = 0x4b6,
...
impl TryFrom<SvcId> for WIPICSvcId {
    ...
    fn try_from(value: SvcId) -> Result<Self, Self::Error> {
        Ok(match value.0 {
            ...
            0xeb => Self::Unk0,
            0xee => Self::Unk11,
            0x12c => Self::InputModeCount,
            0x12d => Self::InputModes,
            0x12e => Self::SetInputMode,
            0x12f => Self::GetInputMode,
            0x320 => Self::TimeNow,
            ...
            0x19c => Self::AvailableDatabaseStorage,
            0x1a0 => Self::Unk8,
            0x258 => Self::Connect,
            0x259 => Self::Close,
            0x25c => Self::SocketWrite,
            0x25e => Self::SocketClose,
            0x385 => Self::HostToNetworkShort,
