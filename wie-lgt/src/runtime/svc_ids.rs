...
pub enum JavaSystemSvcId {
    ...
    MonitorEnter = 33,
    MonitorExit = 34,
    StoreWideArrayUnchecked = 35,
    LoadWideArrayUnchecked = 36,
}
...
impl TryFrom<SvcId> for JavaSystemSvcId {
    ...
    fn try_from(value: SvcId) -> Result<Self, Self::Error> {
        Ok(match value.0 {
            ...
            34 => Self::MonitorExit,
            35 => Self::StoreWideArrayUnchecked,
            36 => Self::LoadWideArrayUnchecked,
            _ => {
...
impl TryFrom<SvcId> for WIPICSvcId {
    ...
    fn try_from(value: SvcId) -> Result<Self, Self::Error> {
        Ok(match value.0 {
            ...
            0x19a => Self::ListResourceDirectories,
            ...
            0x7d0 => Self::Socket,
            0x44c => Self::ListPhoneDataStores,
